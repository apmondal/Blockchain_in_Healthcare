...
contract Patient {
    ...
    {
        patient memory p2 = patientlist[patient_id];
    ...
    {
        attendant memory a2 = attendantlist[patient_id];

        return (a2.attendant_name, a2.attendant_relation, a2.attendant_phn_no);
    }
}
